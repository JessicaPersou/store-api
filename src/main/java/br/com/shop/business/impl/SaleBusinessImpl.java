...
import br.com.shop.repository.SaleRepository;
...
public class SaleBusinessImpl implements SaleBusiness {
    ...
    public SaleDTO createSale(SaleDTO saleDTO) {
        Client client = clientRepository.findById(saleDTO.getBuyerId()).orElseThrow(() -> new RuntimeException("Comprador: " + saleDTO.getBuyerId() + ", não encontrado."));
